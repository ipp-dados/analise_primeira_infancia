...
\figura{grafico}{_build/img/censo_0_a_4_serie_total_ano.png}{Evolução da população de 0 a 4 anos — Censos 2000, 2010 e 2022}{Elaboração IPP com dados de \citeonline{ipp_datario_censo}.}{graf:censo-0-a-4-serie-total-ano}
...
\figura{grafico}{_build/img/censo_0_a_4_serie_percentual_ano.png}{Percentual da população de 0 a 4 anos — Censos 2000, 2010 e 2022}{Elaboração IPP com dados de \citeonline{ipp_datario_censo}.}{graf:censo-0-a-4-serie-percentual-ano}
...
\figura{mapa}{../../mapas/a4/mapa_taxa_mortalidade_precoce_bairro_2025.pdf}{Taxa de óbitos precoces por bairro (2025)}{Elaboração IPP com dados de \citeonline{sms_rio_sim}; \citeonline{sms_rio_sinasc}. Limites de bairros: \citeonline{ipp_limites_bairros}. Sistema de referência SIRGAS 2000. Nota: Escala de cor limitada ao percentil 95 (19,6); o valor real está na tabela do apêndice.}{mapa:mapa-taxa-mortalidade-precoce-bairro-2025}
...
\figura{grafico}{../../visualizacoes/a4/obitos_raca_ano.pdf}{Óbitos de 0 a 364 dias por raça/cor}{Elaboração IPP com dados de \citeonline{sms_rio_sim}; \citeonline{sms_rio_sinasc}.}{graf:obitos-raca-ano}
...
\figura{grafico}{../../visualizacoes/a4/obitos_evitaveis_cap_menores_1_ano_ano.pdf}{Óbitos por causas evitáveis, menores de 1 ano, por CAP}{Elaboração IPP com dados de \citeonline{sms_rio_sim}.}{graf:obitos-evitaveis-cap-menores-1-ano-ano}
...
\figura{mapa}{../../mapas/a4/mapa_percentual_evitaveis_menores_1_ano_cap_2025.pdf}{\% evitáveis, menores de 1 ano, por CAP (2025)}{Elaboração IPP com dados de \citeonline{sms_rio_sim}. Limites de bairros: \citeonline{ipp_limites_bairros}. Sistema de referência SIRGAS 2000.}{mapa:mapa-percentual-evitaveis-menores-1-ano-cap-2025}
...
\figura{grafico}{../../visualizacoes/a4/sidra_taxa_frequencia_0_6_sexo_2022.pdf}{Taxa de frequência escolar bruta por idade e sexo}{Elaboração IPP com dados de \citeonline{ibge_censo2022}.}{graf:sidra-taxa-frequencia-0-6-sexo-2022}
...
\figura{grafico}{../../visualizacoes/a4/cadunico_criancas_por_idade.pdf}{CadÚnico: crianças por idade}{Elaboração IPP com dados de \citeonline{mds_cadunico}.}{graf:cadunico-criancas-por-idade}
...
\figura{grafico}{../../visualizacoes/a4/cadunico_criancas_por_faixa_renda.pdf}{CadÚnico: crianças por faixa de renda}{Elaboração IPP com dados de \citeonline{mds_cadunico}.}{graf:cadunico-criancas-por-faixa-renda}
...
\figura{grafico}{../../visualizacoes/a4/taxa_atendimento_0_a_5_por_ano.pdf}{Taxa bruta de atendimento escolar de 0 a 5 anos (\%)}{Elaboração IPP com dados de \citeonline{inep_censo_escolar}.}{graf:taxa-atendimento-0-a-5-por-ano}
...
\figura{grafico}{../../visualizacoes/a4/violencia_familiar_serie_vinculos.pdf}{Notificações de violência familiar, 0 a 5 anos, por vínculo}{Elaboração IPP com dados de \citeonline{sms_rio_sinan}.}{graf:violencia-familiar-serie-vinculos}
