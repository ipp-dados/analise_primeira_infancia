...
\vertabelas{Tabela~\ref{tab:mortalidade-neonatal-precoce-por-ano}, \texttt{mortalidade\_neonatal\_precoce\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-obitos-neonatal-precoce-2025}; ver Apêndice~\ref{ap:eixo-1}}
...
\vertabelas{Tabela~\ref{tab:mortalidade-neonatal-tardia-por-ano}, \texttt{mortalidade\_neonatal\_tardia\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-obitos-neonatal-tardia-2025}; ver Apêndice~\ref{ap:eixo-1}}
...
\vertabelas{Tabela~\ref{tab:obitos-gravidez-por-ano}, \texttt{obitos\_gravidez\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-obitos-gravidez-2025}; ver Apêndice~\ref{ap:eixo-1}}
...
\vertabelas{Tabela~\ref{tab:obitos-puerperio-por-ano}, \texttt{obitos\_puerperio\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-obitos-puerperio-2025}; ver Apêndice~\ref{ap:eixo-1}}
...
\vertabelas{\texttt{mortalidade\_raca\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:mortalidade-raca-municipio-ano}, Tabela~\ref{tab:tabela-mapa-obitos-raca-total-2025}; ver Apêndice~\ref{ap:eixo-1}}
...
\vertabelas{Tabela~\ref{tab:mortalidade-infantil-pos-neonatal-total-por-ano}, \texttt{mortalidade\_infantil\_pos\_neonatal\_total\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-mortalidade-infantil-2025}; ver Apêndice~\ref{ap:eixo-1}}
...
\vertabelas{Tabela~\ref{tab:violencia-familiar-por-vinculo-ano}, \texttt{violencia\_familiar\_por\_bairro.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-violencia-familiar-mae-2025}, Tabela~\ref{tab:tabela-mapa-violencia-familiar-pai-2025}, Tabela~\ref{tab:tabela-mapa-violencia-familiar-outros-2021-2025}; ver Apêndice~\ref{ap:eixo-4}}
...
\vertabelas{\texttt{notif\_autoprovocada\_por\_bairro\_ano.csv} (formato digital), Tabela~\ref{tab:tabela-mapa-notif-autoprovocada-2026}; ver Apêndice~\ref{ap:eixo-4}}
