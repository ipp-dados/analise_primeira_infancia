...
script (mesmo padrão herdado de `specs/2026-09-09_visual-identity/plan.md` Bloco 6) —
...
- Reaproveita a paleta sequencial por tema já definida
  (`_CORES_TEMA_MAPA`, `specs/2026-09-09_visual-identity/plan.md` §1) — não inventa
  uma nova.
