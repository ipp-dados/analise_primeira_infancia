# SPEC — Relatório final em LaTeX (`specs/2026-09-25_relatorio_latex`)
...
Protótipo aprovado para discussão: `specs/2026-09-25_relatorio_latex/prototipo/comparacao_antes_depois.pdf` (antes ×
...
- Mudar a ordem das seções de `analise.py` (continua ordem de build, `specs/2026-09-22_ajuste_eixos` §9.1).
