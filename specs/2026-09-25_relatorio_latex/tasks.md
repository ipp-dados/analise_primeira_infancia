# Tarefas — `specs/2026-09-25_relatorio_latex`
...
- [x] T4.6 Exclusões decididas pelo usuário (2026-09-25), registradas em `specs/exclusoes.md` (E1-E11): PDF/DOCX via
  ...
  `specs/2026-09-25_website_graficos` (branch `spec/website-graficos`), a pedido do usuário
...
- [x] T6.6 Nota na spec do site (`specs/2026-09-25_website_graficos` §3b) para o site ler as mesmas chaves
