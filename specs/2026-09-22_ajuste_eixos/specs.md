# Especificação — Reorganização por Eixos da Política Municipal (`specs/2026-09-22_ajuste_eixos`)
...
`roadmap.md`/`tech-stack.md`, não dentro de `specs/2026-09-22_ajuste_eixos/`), porque é
...
(`specs/2026-09-22_ajuste_eixos/tasks.md` T6.3): editar `specs/estrutura_eixos.md` à
