...
- Agrupamento por eixo: o gerador continua com o agrupamento fixo em código (não passa a ler
  `specs/estrutura_eixos.md` em tempo de execução — decisão de `specs/2026-09-22_ajuste_eixos` §9.3 mantida).
...
- **P2**: Autorização do logo IPP e placeholders do rodapé continuam pendentes (`specs/2026-09-14_relatorio-interativo`
