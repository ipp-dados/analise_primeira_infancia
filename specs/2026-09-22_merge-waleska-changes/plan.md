...
um commit antigo (`3a258e8`, antes de `specs/2026-09-09_maps-and-ibge`/`specs/2026-09-09_visual-identity`/
`specs/2026-09-14_relatorio-interativo`), mas como as regiões de `analise.py` que ela editou não se
...
Executado: commit `ed964a5` neste branch (`specs/2026-09-22_merge-waleska-changes`, criado a partir de
`planning`).
...
3. Merge de `specs/2026-09-22_merge-waleska-changes` em `planning` (fast-forward, `planning` não andou
