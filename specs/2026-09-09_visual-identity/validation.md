# Validation — specs/2026-09-09_visual-identity
...
que já existia + tudo que `specs/2026-09-09_maps-and-ibge` adicionou — não "~35 novas").
...
- Nenhum mapa quebra com `ValueError: Bin edges must be unique` ou `cannot
  ...
  `specs/2026-09-09_maps-and-ibge` — trocar só o `cmap` não deveria afetar isso, mas
  confirmar).
...
- Contém as ~35 visualizações novas de `specs/2026-09-09_maps-and-ibge` (11 mapas de
...
- V2: 25/25 call sites com `cmap` (4 censo, 3 cadúnico, 3 natalidade, 15
  ...
  regressão dos bugs de `specs/2026-09-09_maps-and-ibge`.
