# Tasks — specs/2026-09-09_visual-identity
...
- [x] **T6.5** — Todas as ~73 visualizações (48 gráficos + a cobertura completa de
      specs/2026-09-09_maps-and-ibge: SIDRA, evitáveis por CAP/subgrupo, D.1/D.2, raça sem "não informada")
...
- [x] **T7.1** — Não necessário: a execução completa do notebook no Bloco 5 já regenerou
      todos os PNGs (74 em `visualizacoes/`, incluindo tudo que `specs/2026-09-09_maps-and-ibge` adicionou)
