...
**`visualizacoes/`** (21):
- 18 PNGs da matriz subgrupo×CAP removida pela curadoria da Waleska (`obitos_evitaveis_{imunizacao,gestacao,parto,recem_nascido,diagnostico_tratamento,promocao_vinculacao}_cap_{1_a_4_anos,menores_1_ano,menores_5_anos}_ano.png`) — já esperado, `specs/merge-waleska-changes`
